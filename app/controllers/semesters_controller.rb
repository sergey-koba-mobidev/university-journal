class SemestersController < ApplicationController
  ...
  before_action AdminOrTeacherActionCallback, only: [:show]

  # GET /semesters
  # GET /semesters.json
  def index
    @semesters = Semester.paginate(page: params[:page], per_page: PER_PAGE)
  end
  ...
  private
    ...
    def semester_params
      params.require(:semester).permit(:year, :pos)
    end
end
